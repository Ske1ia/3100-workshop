...
public class trial{
	public static void main(String[] args){
		try{
			...
			Integer coreNum=Integer.parseInt(jobInfo[4]);
			Integer diskNum=Integer.parseInt(jobInfo[5]);
			Integer memoryNum=Integer.parseInt(jobInfo[6]);
			
			
			
			
			dout.write(("GETS Capable "+coreNum+" "+diskNum+" "+memoryNum+"\n").getBytes());
			
			dout.flush();
			//System.out.println("GETS Capable");
			str=in.readLine();
